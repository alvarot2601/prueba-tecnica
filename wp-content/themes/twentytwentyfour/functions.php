...
function agregar_css() {
    wp_register_style('estilos-personalizados', get_template_directory_uri() . '/css/estilos.css', array(), '1.0', 'all');

    wp_enqueue_style('estilos-personalizados');
}

// Hook para añadir los estilos
